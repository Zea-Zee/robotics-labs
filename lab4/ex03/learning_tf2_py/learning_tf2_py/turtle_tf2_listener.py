    ...
    def on_timer(self):
        ...
        if self.turtle_spawning_service_ready:
            if self.turtle_spawned:
                ...
                angle = math.atan2(y_target - y_current, x_target - x_current)

                scale_rotation_rate = 1.0
                msg.angular.z = scale_rotation_rate * (angle - math.atan2(t_current.transform.rotation.z, t_current.transform.rotation.w) * 2)
